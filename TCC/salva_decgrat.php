<?php
	...
	else
	{
               ...
               $sql1 = "insert into decgrat(nome_aluno,matricula_aluno,turno,status_ativ) values ('$nome','$mat','null','null')";
	...
	if(!$resp)
	{
		...
		die();
               ...
               $sql2 = "select * from decgrat where nome_aluno = '$nome' and matricula_aluno = '$mat'  ";
	...
	if(!$resp1)
	{
		...
		die();
               ...
               echo "<div><p>O aluno <b>$nome</b> tem matricula <b>$mat</b> e tem direito a gratuidade</p></div>"; 
