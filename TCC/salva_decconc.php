<?php
	...
	else
	{
               ...
               $turma = $r['turma'];
               $status = $r['status'];
               $sql1 = "insert into decconc(nome_aluno,matricula_aluno,turma,status) values ('$nome','$mat','null','null')";
	...
	if(!$resp)
	{
		...
		die();
               ...
               $sql2 = "select * from decconc where nome_aluno = '$nome' and matricula_aluno = '$mat'  ";
